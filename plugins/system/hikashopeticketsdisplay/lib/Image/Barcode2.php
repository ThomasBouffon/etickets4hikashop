...
require_once JPATH_SITE . '/plugins/system/hikashopeticketsdisplay/lib/Image/Barcode2/Writer.php';
require_once JPATH_SITE . '/plugins/system/hikashopeticketsdisplay/lib/Image/Barcode2/Driver.php';
require_once JPATH_SITE . '/plugins/system/hikashopeticketsdisplay/lib/Image/Barcode2/Exception.php';
...
class Image_Barcode2
{
    ...
    public static function draw($text, 
        ...
        if (!include_once JPATH_SITE . '/plugins/system/hikashopeticketsdisplay/lib/Image/Barcode2/Driver/' . ucfirst($type) . '.php') {
